...
import resumePDF from "../../assets/Raj_Nasit_CV.pdf";
            ...
            <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-white/70 leading-relaxed">
                        Full Stack Web Development, API Integration, Database
                        Design, UI/UX Design
                      </p>
                    </div>
                  </div>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                  ...
                  <p className="text-sm text-white/70 leading-relaxed">
                    Writing maintainable and efficient code is my priority. I
                    follow best practices and design patterns to ensure that my
              ...
              <div className="relative group">
                ...
                <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                  ...
                  <p className="text-sm text-white/70 leading-relaxed">
                    Optimizing for speed and effieciency in every project.
                  </p>
                </div>
              </div>
                ...
                <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                  <div className="grid grid-cols-3 gap-6 text-center">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-white/60">Client Support</div>
                    </div>
